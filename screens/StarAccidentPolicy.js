    ...
    <SafeAreaView>
      ...
      <View className="py-4 bg-[#115E67] mt-5 mb-5 mx-7 elevation rounded-xl ">
        <Text className="font-medium text-white mx-3 ">
          ...
          to reduce the financial strain that an individual could undergo in the
          event of an accident. Personal Accident insurance is a 24hr worldwide
          policy to provide compensation to the insured or his legal
          representative for:
        </Text>

        <Text className="font-medium text-white mt-2 mx-3 ">· Death</Text>
