      ...
      <View className="bg-[#115E67] mt-5 mx-4 elevation rounded-xl items-center">
        ...
        <View className="flex-row mb-5 items-center justify-center">
          <View
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
                On payment of additional premium, the waiting period for Pre-Existing Diseases 
                can be reduced from 3 years to 1 year this is an optional cover
            </Text>
          </View>
          ...
          >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
                Outpatient consultation and outpatient treatment (Dental & Ophthalmic)
                expenses are covered up to the limits mentioned in the policy clause.
            </Text>
          </View>
        </View>
        ...
        <View className="flex-row mb-20 items-center justify-center">
          ...
          >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
                A cash benefit for each completed day in the hospital is provided up to the limits mentioned in the policy clause for
                a maximum of 7 days per hospitalisation and 120 days per policy period.
            </Text>
          </View>
          ...
          <View style={{ width: 165, height: 175}} className="border border-teal-50 mx-2 mt-1 p-1  mb-5rounded-l" >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
                On exhaustion of the basic Sum Insured during the policy period, 100% of the Sum Insured will be restored once in the policy year that can 
                be utilised for illness or disease for which claims were already made.
            </Text>
          </View>
        </View>
      </View>
