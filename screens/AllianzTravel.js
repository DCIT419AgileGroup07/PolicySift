   ...
   <SafeAreaView>
    ...
    <View className="bg-[#115E67] mt-5 mx-8 elevation rounded-xl ">
            ...
            <Text className='font-medium text-white mt-1 mx-3 '>
                Going on a business trip or flying home for the holidays? Whatever your reason may be, Allianz travel
                insurance gives you the peace of mind you need
                during your trip. Our offering is valid worldwide and fully compliant with the requirements for a Schengen visa.
