  ...
  return (
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="flex-row">
          <TouchableOpacity
            onPress={() => navigation.navigate("StarAccidentPolicy")}
            style={{ width: 155, height: 130 }}
            className="bg-teal-50 elevation mt-7  ml-8  rounded-l items-center"
          >
            <Image
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("StarPersonalGuide")}
            style={{ width: 155, height: 130 }}
            className="bg-teal-50 elevation mt-7  mx-7 rounded-l items-center"
          >
            <Image
        ...
        <View className="items-center mb-5">
          <TouchableOpacity
            onPress={() => navigation.navigate("StarInternationalTravels")}
            style={{ width: 155, height: 130 }}
            className="bg-teal-50 elevation mt-7  ml-8  rounded-l items-center"
          >
            <Image
