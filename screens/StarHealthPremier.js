      ...
      <View className="bg-[#115E67] mt-5 mx-4 elevation rounded-xl items-center">
        ...
        <View className="flex-row mb-5 items-center justify-center">
          ...
          >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
              10% premium discount will be given if the listed health check-ups
              are taken 45 days prior to the date of proposal and submitted the
              documents at the time of inception of this policy.
            </Text>
          </View>
          ...
          >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
              Expenses incurred for Cataract treatment are covered up to the
              limits as mentioned in the Policy Clause.
            </Text>
          </View>
        </View>
        ...
        <View className="flex-row mb-20 items-center justify-center">
          ...
          >
            ...
            <Text className="text-teal-50 mt-1  text-xs font-medium">
              Specially designed policy to cover people who are 50 years and
              above with no maximum entry age limit.
            </Text>
          </View>
        </View>
      </View>
