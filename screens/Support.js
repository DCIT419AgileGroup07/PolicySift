  ...
  return (
    <SafeAreaView>
      <View className="flex-row mt-5">
        ...
        <Text className="text-[#034047] text-2xl font-semibold mt-2 mx-20 text-center">
          Contact Us
        </Text>
      </View>
        ...
        <View>
          ...
          <View className="mx-5">
            <View className="mx-5 mb-1 ">
              <Text className="text-lg text-[#115E67] font-semibold">
                Fullname
              </Text>
            </View>
            ...
            <View className="p-2 border-2 border-[#115E67] rounded-full mb-2 w-full">
              <TextInput keyboardType="numeric" className="text-xl" />
            </View>
            ...
            <View className="my-5">
              <TouchableOpacity className="bg-[#115E67] py-4 px-[120] rounded-full mb-3">
