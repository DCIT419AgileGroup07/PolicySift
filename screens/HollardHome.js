    ...
    <SafeAreaView>
      ...
      <View className="bg-[#115E67] mt-5 mx-8 elevation rounded-xl items-center">
        ...
        <Text className="font-medium text-white mt-7 mx-3 mb-40">
          -Third-party liability cover for injury or damage to third-party
          property {"\n"}
          -Damage caused by the escape of water or oil from fixed water or
          heating installations or domestic appliances {"\n"}
          -Your outbuildings, swimming pools, fences, plumbing and other parts
          of your home. {"\n"}
          -Subsidence and heave of the site on which the building stands or
          landslip {"\n"}
        </Text>
      </View>
    </SafeAreaView>
