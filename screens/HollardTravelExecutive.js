  ...
  return (
    <SafeAreaView>
      ...
      <View className="bg-[#115E67] mt-5 mx-8 elevation rounded-xl ">
        ...
        <Text className="font-bold text-white mt-5 mx-3">Key Benefits</Text>
        ...
        <Text className="font-medium text-white mt-1 mx-3 mb-2 ">
          ...
          -Damage as a result of floods, storms, earthquakes, riots, strikes and
          civil commotion, or while it’s being carried by road, rail, inland
          waterway, lift or elevator {"\n"} {"\n"}
          -Damage to third-party property with a guaranteed limit of
          GHC4,000.00, or death and injury for which the insured is legally
          liable and death to third parties for which you may be legally liable{" "}
          {"\n"}
        </Text>
      </View>
    </SafeAreaView>
