   ...
   <SafeAreaView>
    ...
    <View className="bg-[#115E67] mt-5 mx-7  elevation rounded-xl items-center">
            ...
            <Text className='font-medium text-white mt-5 mx-4 mb-10'>
                Our Fire and Allied Perils policy has been designed to cover losses or damages to your property resulting from Fire, Explosion [specifically of gas used for domestic purposes] and Lightning. It also covers loss or damage aris
                ing from such perils as Impact, [usually by vehicles or animals], riot & strike, bursting or overflowing of water tanks, apparatus or pipes, flood, earthquake, hurricane, tornado, windstorm, cyclone, aircraft or any other aerial device. {"\n"}
