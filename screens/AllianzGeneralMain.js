      ...
      <ScrollView>
        ...
        <View className="items-center">
          <View className="flex-row">
            <TouchableOpacity
              onPress={() => navigation.navigate("AllianzMotor")}
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("AllianzHomePolicy")}
              className="bg-teal-50 elevation mt-7 mx-4 rounded-l items-center"
              style={{ width: 155, height: 130 }}
            >
              <Image
          ...
          <View className="flex-row mb-5">
            <TouchableOpacity
              onPress={() => navigation.navigate("AllianzTravel")}
              style={{ width: 155, height: 130 }}
              className="bg-teal-50 elevation mt-7 rounded-l items-center"
            >
              <Image
