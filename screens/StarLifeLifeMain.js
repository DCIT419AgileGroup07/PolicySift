    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="items-center">
          <TouchableOpacity
            onPress={() => navigation.navigate("StarLifeEmployeeSec")}
            style={{ width: 250, height: 200 }}
            className=" bg-teal-50 elevation mt-20 rounded-l items-center"
          >
            <Image
              source={require("../assets/Images/InsuranceHands.png")}
