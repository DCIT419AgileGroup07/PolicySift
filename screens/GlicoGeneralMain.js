    ...
    <SafeAreaView>
      <ScrollView>
        ...
        <View className="flex-row">
          <TouchableOpacity
            onPress={() => navigation.navigate("GlicoMotor")}
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("GlicoMarine")}
            className="bg-teal-50 elevation mt-7  mx-7 rounded-l items-center"
            style={{ width: 155, height: 130 }}
          >
            <Image
              source={require("../assets/Images/shiponfire.png")}
              className="mt-6"
              style={{ width: 70, height: 50 }}
            />
        ...
        <View className="flex-row mb-5 ">
          <TouchableOpacity
            onPress={() => navigation.navigate("GlicoSpecialty")}
            style={{ width: 155, height: 130 }}
            className="bg-teal-50 elevation mt-7  ml-8  rounded-l items-center"
          >
            <Image
              source={require("../assets/Images/workman.png")}
              className="mt-6"
          ...
          <TouchableOpacity
            onPress={() => navigation.navigate("GlicoFire")}
            style={{ width: 155, height: 130 }}
            className="bg-teal-50 elevation mt-7  ml-8  rounded-l items-center"
          >
            <Image
              source={require("../assets/Images/Firedhouse.png")}
              className="mt-5"
              style={{ width: 70, height: 50 }}
            />
            <Text className="text-teal-800 mt-1 text-center text-xs font-medium">
