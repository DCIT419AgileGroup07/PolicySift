  ...
  return (
    <SafeAreaView>
      ...
      <View className="py-4 bg-[#115E67] mt-5 mb-5 mx-4 elevation rounded-xl ">
        ...
        This is the accumulated lump sum (savings plus interest) payable to the 
        life assured upon the maturity of the policy or upon the earlier death 
        of the life assured during the term of the policy.
        </Text>

        <Text className="font-medium text-white mx-3 ">Protection Benefits:</Text>
        <Text className="font-medium text-white mx-3 ">
