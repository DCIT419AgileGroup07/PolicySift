    ...
    <View className="bg-[#115E67] mt-5 mx-8 p-2 elevation rounded-xl items-center">
             ...
             <Text className='font-bold text-white mt-5'>
              ...
              <Text className='font-medium text-white mt-5 mx-3 mb-10'>
                This is our minimum cover and it 
                covers your liabilities to third parties in respect of damage caused to the property [ies] of such third party or injury/death to the third parties as a result of the use of your vehicle. {"\n"} {"\n"}
                ...
                Your choice of the Third Party Motor Insurance policy would not cover any loss or damage to your own vehicle. {"\n"} Please choose our Comprehensive Motor Insurance Policy to have this risk covered
              </Text>
    </View>
   </SafeAreaView>
  )
