   ...
   <SafeAreaView>
    ...
    <View className="bg-[#115E67] mt-5 mx-8 elevation rounded-xl items-center">
            ...
            <Text className='font-medium text-white mt-5 mx-3 '>
                ...
                -You have sustained a bodily injury caused by a violent accident of external and visible means {"\n"}
                -The accident has resulted in death, permanent or temporary total disability and corresponding medical expenses {"\n"}
            ...
            <Text className='font-medium text-white mt-5 mx-3 mb-4'>
                ...
                We also offer optional extensions to your cover for these types of accidents: {"\n"}
                -Exposure to elements, starvation and/or thirst {"\n"}
                -Disappearance {"\n"}
                -Burn accidents causing disfigurement {"\n"}
                -An accident resulting in the need for a life support system for more than 2 consecutive days {"\n"}
            </Text>
    </View>
   </SafeAreaView>
  )
