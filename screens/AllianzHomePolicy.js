  ...
  return (
    <SafeAreaView>
      ...
      <View className="bg-[#115E67] mt-5 mx-8 elevation rounded-xl ">
        ...
        <Text className="font-medium text-white mx-3 mt-5 ">What We Cover</Text>
        ...
        <View className="flex-row mb-5 items-center justify-center">
          <View
            ...
            className="border border-teal-50  mt-1 p-1 rounded-l"
          >
            ...
            <Text className="text-teal-50 mt-1 text-center text-xs font-medium">
              Covers your legal liability as the house owner for injuries or
              death of third parties at your place of residence arising from
              your negligence.{" "}
            </Text>
          </View>
          ...
          >
            ...
            <Text className="text-teal-50 mt-1 text-center text-xs font-medium">
              Compensate you and your household whenever you sustain accidental
              bodily injury.{" "}
            </Text>
          </View>
        </View>
        ...
        <View className="items-center justify-center mb-2">
          <View
            ...
            className="border border-teal-50  mt-1 mb-3 p-1 rounded-l items-center "
          >
            <Text className="text-teal-50 mt-1 text-center text-xs font-bold">
              {" "}
              Rent
            ...
            <Text className="text-teal-50 mt-1 text-center text-xs font-medium">
              {" "}
              We pay up to 12 month loss of rent following damage to your
              property which makes the place not suitable for rental.
            </Text>
          </View>
        </View>
      </View>
