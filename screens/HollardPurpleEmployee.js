    ...
    <SafeAreaView>
      ...
      <View className="py-4 bg-[#115E67] mt-5 mb-5 mx-4 elevation rounded-xl ">
        <Text className="font-medium text-white mx-3 ">
          ...
          thus, the wellbeing of employees becomes paramount for the sustenance
          of any business.
        </Text>

        <Text className="font-medium text-white mx-3 ">
          Hollard Life, as a family oriented brand, with several years of
          experience, understands and recognizes the importance of ensuring that
          organizations have adequate insurance cover for their employees and
          their families. Unlike the limited Workmen’s Compensation cover, the
          Purple Employee Plan provides a more comprehensive, adequate and
          substantial cover at competitive premiums. The Purple Employee Plan
          offers a 24 hour protection to employees throughout their employment.
        </Text>
        <Text className="font-medium text-white mx-3 ">
        ...
        <Text className="font-medium text-white mx-3 ">· Critical Illness</Text>
        <Text className="font-medium text-white mx-3 ">· Health Screening</Text>
        <Text className="font-medium text-white mx-3 ">
