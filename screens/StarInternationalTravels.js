    ...
    <SafeAreaView>
      ...
      <View className="py-4 bg-[#115E67] mt-5 mb-5 mx-4 elevation rounded-xl ">
        <Text className="font-medium text-white mx-3 ">
          Travelling is always an exciting activity be it for leisure or
          business. The fun and excitement come with the responsibility to make
          your journey safe. Your desire to have a fun-filled travel without
          worries is what we aim to achieve. Star's Travel Insurance provides
          cover for travelers when they leave the shores of Ghana against a
          broad range of mishaps and host of unforeseen events that may occur in
          the course of their trip.
        </Text>

        <Text className="font-bold text-white mx-3 ">Benefits</Text>
        <Text className="font-medium text-white mx-3 ">
          The policy provides cover for Medical, Emergency Service &
        ...
        <Text className="font-medium text-white mx-3 ">· Hospitalization</Text>
        <Text className="font-medium text-white mx-3 ">
        ...
        <Text className="font-medium text-white mx-3 ">
          · Compensation (expense for replacement) for loss of essential
          documents
        </Text>
        <Text className="font-medium text-white mx-3 ">
          · Compensation for in-flight loss of checked-in luggage
        </Text>
        <Text className="font-medium text-white mx-3 ">· Hijack Benefit</Text>
      </View>
    </SafeAreaView>
  );
}
